/**
  ...
  *  @since: 28/04/2020
  *  @desc: Clase híbrida GRASP-VNS, algoritmo de la hora de MODIFICACIÓN
  *  @references:
  ...
  *
  *  @version:
  *              28/04/2020 - Creación (primera versión) del código.
  */
...
class ModificactionAlgorithm : public MaxMeanAlgorithm {
private:
...
public:
  ModificactionAlgorithm(Graph workingGraph);
