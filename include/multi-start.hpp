/**
  ...
  *  @since: 23/04/2020
  *  @desc: Clase Multiarranque, que es uno de los algoritmos que resuelve el max-mean problem
  *  @references:
...
class MultiStartAlgorithm : public MaxMeanAlgorithm {
private:
  ...
  // en cada paso añade un nodo cualquiera que no esté todavía en la solución.
...
public:
  MultiStartAlgorithm(Graph workingGraph);
